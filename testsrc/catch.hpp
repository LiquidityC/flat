...
auto
operator+(StringRef const& lhs, char const* rhs) -> std::string;
auto
...
template<typename ArgT, typename MatcherT>
auto
makeMatchExpr(ArgT const& arg, MatcherT const& matcher, StringRef matcherString)
...
auto
StringRef::operator[](size_type index) const noexcept -> char
{
