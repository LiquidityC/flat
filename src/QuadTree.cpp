...
namespace flat2d {
int
QuadTree::getNodeIndexFor(const Entity* e) const
{
...
QuadTree::split()
{
	...
	nodes.push_back(new QuadTree(
	  Square(bounds.getXpos() + dw, bounds.getYpos() + dh, dw, dh), depth + 1));
...
void
QuadTree::retrieve(std::vector<Entity*>* returnEntities,
