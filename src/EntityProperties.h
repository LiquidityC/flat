...
namespace flat2d
{
	 ...
	 * code structure. The EntityProperties holds data such as position, velocity
	 * etc. You should never have to create this object in game code. It's automatically
	 * created and attached to your derived Entity objects
	...
	class EntityProperties : public Square
	{
		...
		public:
			...
			/**
			 * Get the collider shape for the Entity. This is offset within EntityProperties bounds
			 * meaning that if it starts at the top left corner the index for x,y will be 0,0
