...
namespace flat2d {
void
CollisionDetector::handlePossibleCollisionsFor(Entity* e, const GameData* data)
{
...
bool
CollisionDetector::handlePossibleCollision(Entity* o1,
                                           Entity* o2,
                                           const GameData* data)
{
	if (*o1 == *o2) {
...
bool
CollisionDetector::AABB(const EntityShape& b1, const EntityShape& b2) const
{
...
float
CollisionDetector::sweptAABB(EntityProperties* p1,
                             EntityProperties* p2,
                             float* normalx,
                             float* normaly) const
{
...
void
CollisionDetector::handleHorizontalCollisions(EntityProperties* props1,
...
void
CollisionDetector::handleVerticalCollisions(EntityProperties* props1,
                                            EntityProperties* props2) const
{
...
void
CollisionDetector::handleVerticalSolidCollision(EntityProperties* props1,
                                                EntityProperties* props2) const
{
	EntityShape colliderShape = props2->getColliderShape();
...
void
CollisionDetector::handleHorizontalSolidCollision(
...
void
CollisionDetector::handleVerticalBouncyCollision(EntityProperties* props1,
                                                 EntityProperties* props2) const
{
...
void
CollisionDetector::handleHorizontalBouncyCollision(
  EntityProperties* props1,
  EntityProperties* props2) const
{
...
void
CollisionDetector::handleVerticalStickyCollision(EntityProperties* props1,
                                                 EntityProperties* props2) const
{
	EntityShape colliderShape = props2->getColliderShape();
...
void
CollisionDetector::handleHorizontalStickyCollision(
  EntityProperties* props1,
  EntityProperties* props2) const
{
	EntityShape colliderShape = props2->getColliderShape();
