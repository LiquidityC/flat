...
void
RuntimeAnalyzer::addCall(std::string func, int time)
{
...
const RuntimeAnalyzer::IntMap*
RuntimeAnalyzer::getTotalTimes()
{
	return &totalTime;
}

const RuntimeAnalyzer::FloatMap*
RuntimeAnalyzer::getAvgTimes()
{
	return &avgTime;
}
} // namespace flat2d
