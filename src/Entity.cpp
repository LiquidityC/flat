...
void
Entity::render(const RenderData* data) const
{
...
void
Entity::setClip(const SDL_Rect& clip)
{
	this->clip = clip;
}

const std::weak_ptr<Texture>
...
void
Entity::setSharedTexture(const std::shared_ptr<Texture>& texture)
{
	this->texture = texture;
}

void
Entity::setTexture(Texture* texture)
{
	this->texture = std::shared_ptr<Texture>(texture);
}

bool
Entity::isFixedPosition()
{
	return fixedPosition;
}

void
Entity::setFixedPosition(bool fixedPosition)
{
	this->fixedPosition = fixedPosition;
}

bool
Entity::isInputHandler()
{
	return inputHandler;
}

void
Entity::setInputHandler(bool inputHandler)
{
	this->inputHandler = inputHandler;
}

void
Entity::addAnimation(std::string id, Animation* animation)
{
...
void
Entity::startAnimation(std::string id)
{
	assert(animations.find(id) != animations.end());
...
bool
Entity::onCollision(Entity* collider, const GameData* data)
{
	return false;
}

bool
Entity::onVerticalCollision(Entity* collider, const GameData* data)
{
	return false;
}

bool
Entity::onHorizontalCollision(Entity* collider, const GameData* data)
{
	return false;
}

const EntityProperties&
Entity::getEntityProperties() const
{
	return entityProperties;
}
} // namespace flat2d
