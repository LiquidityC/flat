...
namespace flat2d {
SDL_Texture*
MediaUtil::loadTexture(const std::string& path, SDL_Renderer* renderer)
{
...
TTF_Font*
MediaUtil::loadFont(const std::string& ttfPath, size_t size)
{
...
SDL_Texture*
MediaUtil::createTextTexture(const std::string& text,
                             TTF_Font* font,
                             SDL_Color color,
...
SDL_Texture*
MediaUtil::loadTextTexture(const std::string& text,
